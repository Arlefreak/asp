...
class Proyect(models.Model):
    name_es = models.CharField(
        'Name spanish', max_length=140, null=False, blank=False)
    name_en = models.CharField(
        'Name english', max_length=140, null=True, blank=True)
    location = models.CharField(
        'Location', max_length=140, null=True, blank=True)
    date = models.CharField('Fechas', max_length=140, null=True, blank=True)
    description_es = RichTextField()
    description_en = RichTextField()
    socialText_es = models.CharField(
        'Social spanish', max_length=100, null=True, blank=True)
    socialText_en = models.CharField(
        'Social english', max_length=100, null=True, blank=True)
    pub_date = models.DateTimeField(
        'Created', editable=False, auto_now_add=True)
    mainImage = models.ImageField(
        'Main Image', upload_to=upload_image_to, blank=False)
    ...
    secondImage = models.ImageField(
        'Second Image', upload_to=upload_image_to, blank=True, null=True)
    imageOrientationOpts = (('left', 'left'), ('rigt', 'right'), ('up', 'up'),
                            ('down', 'down'), ('cntr', 'center'))
    imageOrientation = models.CharField(
        'Alignment',
        max_length=4,
        choices=imageOrientationOpts,
        default='cntr')
    ...
    order = models.PositiveSmallIntegerField(
        'Order', blank=False, null=False, default=1)
...
class Image(models.Model):
    ...
    image = models.ImageField(
        'Image', upload_to=upload_image_to, blank=False, null=False)
    imageOrientationOpts = (('left', 'left'), ('rigt', 'right'),
                            ('cntr', 'center'), ('covr', 'cover'))
    imageOrientation = models.CharField(
        'Tipo', max_length=4, choices=imageOrientationOpts, default='covr')
    imageEffectsOptions = (('no', 'None'), ('bw', 'Black & white'),
                           ('one', 'Effect 1'), ('two', 'Effect 2'),
                           ('tre', 'Effect 3'))
    imageEffect = models.CharField(
        'Effect', max_length=4, choices=imageEffectsOptions, default='no')
    order = models.PositiveSmallIntegerField(
        'Order', blank=False, null=False, default=1)
...
class SingleInformation(SingletonModel):
    aboutImage = models.ImageField(
        'Imagen about', upload_to=upload_image_to, null=False, blank=False)
...
class Press(models.Model):
    name_es = models.CharField(
        'Name spanish', max_length=140, null=False, blank=False)
    name_en = models.CharField(
        'Name english', max_length=140, null=False, blank=False)
    image = models.ImageField(
        'Main image', upload_to=upload_image_to, null=False, blank=False)
