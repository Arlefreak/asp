    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=portfolio.models.upload_image_to, null=True, verbose_name=b'Image', blank=True)),
                ('imageOrientation', models.CharField(default=b'covr', max_length=4, verbose_name=b'Tipo', choices=[(b'left', b'left'), (b'rigt', b'right'), (b'up', b'up'), (b'down', b'down'), (b'cntr', b'center'), (b'covr', b'cover')])),
            ],
            options={
                'verbose_name': 'Imagen',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_es', models.CharField(max_length=140, verbose_name=b'Name spanish')),
                ('name_en', models.CharField(max_length=140, verbose_name=b'Name english')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name_es', models.CharField(max_length=140, verbose_name=b'Name spanish')),
                ('name_en', models.CharField(max_length=140, null=True, verbose_name=b'Name english', blank=True)),
                ('location', models.CharField(max_length=140, null=True, verbose_name=b'Location', blank=True)),
                ('date', models.CharField(max_length=140, null=True, verbose_name=b'Fechas', blank=True)),
                ('description_es', ckeditor.fields.RichTextField()),
                ('description_en', ckeditor.fields.RichTextField()),
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name=b'Created')),
                ('mainImage', models.ImageField(upload_to=portfolio.models.upload_image_to, verbose_name=b'Main Image')),
                ('secondImage', models.ImageField(upload_to=portfolio.models.upload_image_to, verbose_name=b'Second Image', blank=True)),
                ('imageOrientation', models.CharField(default=b'cntr', max_length=4, verbose_name=b'Alignment', choices=[(b'left', b'left'), (b'rigt', b'right'), (b'up', b'up'), (b'down', b'down'), (b'cntr', b'center')])),
